...
import { X, ExternalLink, Award, Cpu, CheckCircle2 } from 'lucide-react';
            ...
            {project.link && project.link !== '#' && (
              <div className="pt-2">
                <a
                  ...
                  className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-gradient-to-r from-purple-600 to-indigo-600 text-white text-xs sm:text-sm font-medium uppercase tracking-wider hover:opacity-90 transition-all"
                >
